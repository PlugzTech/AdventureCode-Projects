const component = {
  "id": "backend-ops-1137",
  "name": "Backup Scope Map 1137",
  "category": "backup",
  "purpose": "Defines backup scope, integrity checks, and restore-point metadata for backend data stores. Batch item 1137 focuses on backup operations wave 7.",
  "inputs": [
    "data store name",
    "snapshot id",
    "backup window"
