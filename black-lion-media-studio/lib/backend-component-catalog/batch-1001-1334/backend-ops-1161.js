const component = {
  "id": "backend-ops-1161",
  "name": "Session Claim Guard 1161",
  "category": "auth",
  "purpose": "Defines reusable checks for authentication state, role claims, and service credential boundaries before backend work proceeds. Batch item 1161 focuses on auth operations wave 9.",
  "inputs": [
