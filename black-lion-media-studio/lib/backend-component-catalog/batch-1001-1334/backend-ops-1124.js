const component = {
  "id": "backend-ops-1124",
  "name": "Rules Alignment Probe 1124",
  "category": "firestore",
  "purpose": "Captures Firestore document contracts, rule expectations, and retry behavior for operational data paths. Batch item 1124 focuses on firestore operations wave 7.",
  "inputs": [
    "collection name",
    "document schema",
