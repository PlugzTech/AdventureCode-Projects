const component = {
  "id": "backend-ops-1223",
  "name": "App Instance Registry 1223",
  "category": "firebase",
  "purpose": "Documents Firebase admin setup, project targeting, and environment separation for backend processes. Batch item 1223 focuses on firebase operations wave 12.",
  "inputs": [
    "Firebase project id",
    "admin app name",
    "runtime environment"
