const component = {
  "id": "backend-ops-1063",
  "name": "App Instance Registry 1063",
  "category": "firebase",
  "purpose": "Documents Firebase admin setup, project targeting, and environment separation for backend processes. Batch item 1063 focuses on firebase operations wave 4.",
  "inputs": [
    "Firebase project id",
    "admin app name",
    "runtime environment"
