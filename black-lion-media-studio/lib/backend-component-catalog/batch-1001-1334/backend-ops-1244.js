const component = {
  "id": "backend-ops-1244",
  "name": "Document Write Contract 1244",
  "category": "firestore",
  "purpose": "Captures Firestore document contracts, rule expectations, and retry behavior for operational data paths. Batch item 1244 focuses on firestore operations wave 13.",
  "inputs": [
    "collection name",
    "document schema",
