const component = {
  "id": "backend-ops-1320",
  "name": "Maintenance Window Marker 1320",
  "category": "scheduling",
  "purpose": "Defines scheduled task timing, maintenance windows, and calendar-sensitive backend operations. Batch item 1320 focuses on scheduling operations wave 16.",
  "inputs": [
    "schedule expression",
    "timezone",
