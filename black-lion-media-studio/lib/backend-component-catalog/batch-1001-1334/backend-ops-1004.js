const component = {
  "id": "backend-ops-1004",
  "name": "Document Write Contract 1004",
  "category": "firestore",
  "purpose": "Captures Firestore document contracts, rule expectations, and retry behavior for operational data paths. Batch item 1004 focuses on firestore operations wave 1.",
  "inputs": [
    "collection name",
    "document schema",
