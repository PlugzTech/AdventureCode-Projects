const component = {
  "id": "backend-ops-1017",
  "name": "Snapshot Plan Record 1017",
  "category": "backup",
  "purpose": "Defines backup scope, integrity checks, and restore-point metadata for backend data stores. Batch item 1017 focuses on backup operations wave 1.",
  "inputs": [
    "data store name",
    "snapshot id",
    "backup window"
