const component = {
  "id": "backend-ops-1241",
  "name": "Session Claim Guard 1241",
  "category": "auth",
  "purpose": "Defines reusable checks for authentication state, role claims, and service credential boundaries before backend work proceeds. Batch item 1241 focuses on auth operations wave 13.",
  "inputs": [
