const component = {
  "id": "backend-ops-1237",
  "name": "Restore Point Catalog 1237",
  "category": "backup",
  "purpose": "Defines backup scope, integrity checks, and restore-point metadata for backend data stores. Batch item 1237 focuses on backup operations wave 12.",
  "inputs": [
    "data store name",
    "snapshot id",
    "backup window"
