const component = {
  "id": "backend-ops-1317",
  "name": "Restore Point Catalog 1317",
  "category": "backup",
  "purpose": "Defines backup scope, integrity checks, and restore-point metadata for backend data stores. Batch item 1317 focuses on backup operations wave 16.",
  "inputs": [
    "data store name",
    "snapshot id",
    "backup window"
