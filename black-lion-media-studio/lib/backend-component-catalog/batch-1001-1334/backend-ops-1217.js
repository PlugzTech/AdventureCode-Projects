const component = {
  "id": "backend-ops-1217",
  "name": "Backup Scope Map 1217",
  "category": "backup",
  "purpose": "Defines backup scope, integrity checks, and restore-point metadata for backend data stores. Batch item 1217 focuses on backup operations wave 11.",
  "inputs": [
    "data store name",
    "snapshot id",
    "backup window"
