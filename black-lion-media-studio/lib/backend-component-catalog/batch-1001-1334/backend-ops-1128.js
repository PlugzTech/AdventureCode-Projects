const component = {
  "id": "backend-ops-1128",
  "name": "Data Mutation Journal 1128",
  "category": "audit",
  "purpose": "Defines durable audit event structure for backend actions and administrative changes. Batch item 1128 focuses on audit operations wave 7.",
  "inputs": [
    "actor id",
    "action name",
    "target resource"
