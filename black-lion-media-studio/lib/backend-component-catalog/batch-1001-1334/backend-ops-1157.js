const component = {
  "id": "backend-ops-1157",
  "name": "Restore Point Catalog 1157",
  "category": "backup",
  "purpose": "Defines backup scope, integrity checks, and restore-point metadata for backend data stores. Batch item 1157 focuses on backup operations wave 8.",
  "inputs": [
    "data store name",
    "snapshot id",
    "backup window"
