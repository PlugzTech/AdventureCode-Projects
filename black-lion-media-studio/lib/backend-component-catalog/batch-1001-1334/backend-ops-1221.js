const component = {
  "id": "backend-ops-1221",
  "name": "Service Account Scope Review 1221",
  "category": "auth",
  "purpose": "Defines reusable checks for authentication state, role claims, and service credential boundaries before backend work proceeds. Batch item 1221 focuses on auth operations wave 12.",
  "inputs": [
