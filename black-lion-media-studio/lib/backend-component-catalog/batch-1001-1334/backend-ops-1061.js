const component = {
  "id": "backend-ops-1061",
  "name": "Service Account Scope Review 1061",
  "category": "auth",
  "purpose": "Defines reusable checks for authentication state, role claims, and service credential boundaries before backend work proceeds. Batch item 1061 focuses on auth operations wave 4.",
  "inputs": [
