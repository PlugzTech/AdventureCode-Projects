const component = {
  "id": "backend-ops-1040",
  "name": "Deferred Task Planner 1040",
  "category": "scheduling",
  "purpose": "Defines scheduled task timing, maintenance windows, and calendar-sensitive backend operations. Batch item 1040 focuses on scheduling operations wave 2.",
  "inputs": [
    "schedule expression",
    "timezone",
