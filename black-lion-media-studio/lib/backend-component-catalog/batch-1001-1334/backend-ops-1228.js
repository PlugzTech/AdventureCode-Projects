const component = {
  "id": "backend-ops-1228",
  "name": "Access Review Export 1228",
  "category": "audit",
  "purpose": "Defines durable audit event structure for backend actions and administrative changes. Batch item 1228 focuses on audit operations wave 12.",
  "inputs": [
    "actor id",
    "action name",
    "target resource"
