const component = {
  "id": "backend-ops-1020",
  "name": "Cron Window Profile 1020",
  "category": "scheduling",
  "purpose": "Defines scheduled task timing, maintenance windows, and calendar-sensitive backend operations. Batch item 1020 focuses on scheduling operations wave 1.",
  "inputs": [
    "schedule expression",
    "timezone",
