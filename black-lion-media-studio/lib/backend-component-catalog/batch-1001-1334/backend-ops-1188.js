const component = {
  "id": "backend-ops-1188",
  "name": "Admin Action Trace 1188",
  "category": "audit",
  "purpose": "Defines durable audit event structure for backend actions and administrative changes. Batch item 1188 focuses on audit operations wave 10.",
  "inputs": [
    "actor id",
    "action name",
    "target resource"
