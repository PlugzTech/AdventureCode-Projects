const component = {
  "id": "backend-ops-1257",
  "name": "Snapshot Plan Record 1257",
  "category": "backup",
  "purpose": "Defines backup scope, integrity checks, and restore-point metadata for backend data stores. Batch item 1257 focuses on backup operations wave 13.",
  "inputs": [
    "data store name",
    "snapshot id",
    "backup window"
