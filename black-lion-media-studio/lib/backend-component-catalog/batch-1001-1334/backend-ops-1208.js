const component = {
  "id": "backend-ops-1208",
  "name": "Data Mutation Journal 1208",
  "category": "audit",
  "purpose": "Defines durable audit event structure for backend actions and administrative changes. Batch item 1208 focuses on audit operations wave 11.",
  "inputs": [
    "actor id",
    "action name",
    "target resource"
