const component = {
  "id": "backend-ops-1146",
  "name": "Refund Audit Link 1146",
  "category": "billing",
  "purpose": "Models billing event intake, reconciliation, and audit references without embedding payment provider secrets. Batch item 1146 focuses on billing operations wave 8.",
  "inputs": [
    "provider event id",
    "customer reference",
    "amount metadata"
