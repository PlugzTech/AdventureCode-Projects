const component = {
  "id": "backend-ops-1097",
  "name": "Snapshot Plan Record 1097",
  "category": "backup",
  "purpose": "Defines backup scope, integrity checks, and restore-point metadata for backend data stores. Batch item 1097 focuses on backup operations wave 5.",
  "inputs": [
    "data store name",
    "snapshot id",
    "backup window"
