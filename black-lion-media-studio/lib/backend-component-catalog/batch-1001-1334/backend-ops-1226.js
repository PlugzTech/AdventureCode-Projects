const component = {
  "id": "backend-ops-1226",
  "name": "Refund Audit Link 1226",
  "category": "billing",
  "purpose": "Models billing event intake, reconciliation, and audit references without embedding payment provider secrets. Batch item 1226 focuses on billing operations wave 12.",
  "inputs": [
    "provider event id",
    "customer reference",
    "amount metadata"
