const component = {
  "id": "backend-ops-1200",
  "name": "Deferred Task Planner 1200",
  "category": "scheduling",
  "purpose": "Defines scheduled task timing, maintenance windows, and calendar-sensitive backend operations. Batch item 1200 focuses on scheduling operations wave 10.",
  "inputs": [
    "schedule expression",
    "timezone",
