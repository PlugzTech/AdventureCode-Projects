const component = {
  "id": "backend-ops-1304",
  "name": "Transaction Retry Profile 1304",
  "category": "firestore",
  "purpose": "Captures Firestore document contracts, rule expectations, and retry behavior for operational data paths. Batch item 1304 focuses on firestore operations wave 16.",
  "inputs": [
    "collection name",
    "document schema",
