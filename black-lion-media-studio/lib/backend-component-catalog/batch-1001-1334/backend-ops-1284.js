const component = {
  "id": "backend-ops-1284",
  "name": "Rules Alignment Probe 1284",
  "category": "firestore",
  "purpose": "Captures Firestore document contracts, rule expectations, and retry behavior for operational data paths. Batch item 1284 focuses on firestore operations wave 15.",
  "inputs": [
    "collection name",
    "document schema",
