const component = {
  "id": "backend-ops-1001",
  "name": "Session Claim Guard 1001",
  "category": "auth",
  "purpose": "Defines reusable checks for authentication state, role claims, and service credential boundaries before backend work proceeds. Batch item 1001 focuses on auth operations wave 1.",
  "inputs": [
