const component = {
  "id": "backend-ops-1028",
  "name": "Admin Action Trace 1028",
  "category": "audit",
  "purpose": "Defines durable audit event structure for backend actions and administrative changes. Batch item 1028 focuses on audit operations wave 2.",
  "inputs": [
    "actor id",
    "action name",
    "target resource"
