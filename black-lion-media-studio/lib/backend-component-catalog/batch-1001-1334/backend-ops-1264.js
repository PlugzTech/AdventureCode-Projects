const component = {
  "id": "backend-ops-1264",
  "name": "Collection Index Review 1264",
  "category": "firestore",
  "purpose": "Captures Firestore document contracts, rule expectations, and retry behavior for operational data paths. Batch item 1264 focuses on firestore operations wave 14.",
  "inputs": [
    "collection name",
    "document schema",
