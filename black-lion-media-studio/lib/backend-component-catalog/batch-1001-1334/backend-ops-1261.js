const component = {
  "id": "backend-ops-1261",
  "name": "Role Boundary Verifier 1261",
  "category": "auth",
  "purpose": "Defines reusable checks for authentication state, role claims, and service credential boundaries before backend work proceeds. Batch item 1261 focuses on auth operations wave 14.",
  "inputs": [
