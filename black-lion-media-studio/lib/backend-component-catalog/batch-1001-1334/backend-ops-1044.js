const component = {
  "id": "backend-ops-1044",
  "name": "Rules Alignment Probe 1044",
  "category": "firestore",
  "purpose": "Captures Firestore document contracts, rule expectations, and retry behavior for operational data paths. Batch item 1044 focuses on firestore operations wave 3.",
  "inputs": [
    "collection name",
    "document schema",
