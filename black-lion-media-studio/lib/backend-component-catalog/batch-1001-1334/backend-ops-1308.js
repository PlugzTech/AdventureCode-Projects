const component = {
  "id": "backend-ops-1308",
  "name": "Access Review Export 1308",
  "category": "audit",
  "purpose": "Defines durable audit event structure for backend actions and administrative changes. Batch item 1308 focuses on audit operations wave 16.",
  "inputs": [
    "actor id",
    "action name",
    "target resource"
