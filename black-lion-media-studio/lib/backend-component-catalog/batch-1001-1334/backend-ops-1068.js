const component = {
  "id": "backend-ops-1068",
  "name": "Access Review Export 1068",
  "category": "audit",
  "purpose": "Defines durable audit event structure for backend actions and administrative changes. Batch item 1068 focuses on audit operations wave 4.",
  "inputs": [
    "actor id",
    "action name",
    "target resource"
