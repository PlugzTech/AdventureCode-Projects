const component = {
  "id": "backend-ops-1288",
  "name": "Data Mutation Journal 1288",
  "category": "audit",
  "purpose": "Defines durable audit event structure for backend actions and administrative changes. Batch item 1288 focuses on audit operations wave 15.",
  "inputs": [
    "actor id",
    "action name",
    "target resource"
