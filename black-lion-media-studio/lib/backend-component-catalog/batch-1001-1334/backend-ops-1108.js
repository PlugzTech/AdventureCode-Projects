const component = {
  "id": "backend-ops-1108",
  "name": "Admin Action Trace 1108",
  "category": "audit",
  "purpose": "Defines durable audit event structure for backend actions and administrative changes. Batch item 1108 focuses on audit operations wave 6.",
  "inputs": [
    "actor id",
    "action name",
    "target resource"
