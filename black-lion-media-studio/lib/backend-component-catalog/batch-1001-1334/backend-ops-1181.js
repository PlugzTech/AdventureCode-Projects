const component = {
  "id": "backend-ops-1181",
  "name": "Role Boundary Verifier 1181",
  "category": "auth",
  "purpose": "Defines reusable checks for authentication state, role claims, and service credential boundaries before backend work proceeds. Batch item 1181 focuses on auth operations wave 10.",
  "inputs": [
