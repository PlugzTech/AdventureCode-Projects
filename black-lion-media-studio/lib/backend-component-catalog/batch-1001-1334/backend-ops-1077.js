const component = {
  "id": "backend-ops-1077",
  "name": "Restore Point Catalog 1077",
  "category": "backup",
  "purpose": "Defines backup scope, integrity checks, and restore-point metadata for backend data stores. Batch item 1077 focuses on backup operations wave 4.",
  "inputs": [
    "data store name",
    "snapshot id",
    "backup window"
