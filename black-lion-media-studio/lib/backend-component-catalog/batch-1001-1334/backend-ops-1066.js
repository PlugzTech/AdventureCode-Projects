const component = {
  "id": "backend-ops-1066",
  "name": "Refund Audit Link 1066",
  "category": "billing",
  "purpose": "Models billing event intake, reconciliation, and audit references without embedding payment provider secrets. Batch item 1066 focuses on billing operations wave 4.",
  "inputs": [
    "provider event id",
    "customer reference",
    "amount metadata"
