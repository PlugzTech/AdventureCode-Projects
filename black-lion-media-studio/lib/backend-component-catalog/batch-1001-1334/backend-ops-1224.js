const component = {
  "id": "backend-ops-1224",
  "name": "Transaction Retry Profile 1224",
  "category": "firestore",
  "purpose": "Captures Firestore document contracts, rule expectations, and retry behavior for operational data paths. Batch item 1224 focuses on firestore operations wave 12.",
  "inputs": [
    "collection name",
    "document schema",
